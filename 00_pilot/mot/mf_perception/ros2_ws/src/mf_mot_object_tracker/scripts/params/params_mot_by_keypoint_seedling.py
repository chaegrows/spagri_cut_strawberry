...
## yolo detection 
model_path = '/workspace/Metafarmers/ai_models/seedling/seedlings-pose-v1.pt'
conf_thresh = 0.2
iou_thresh = 0.01
use_cuda = False
...
print_labels = True
inference_output_type = ['bbox', 'keypoint']

debug_on_depth = True
max_depth_meter = 0.3

# inference_output_type = ['keypoint']
...
# other utils
use_tapfarmers_adapter = False
tapfarmers_topic_name = '/fruit_mot/fruits'
