...
def generate_launch_description():
    ARGUMENTS =[
        ...
        DeclareLaunchArgument('host',  default_value = '192.168.50.161', description = 'ROBOT_IP'       ),
    ...
    mf_manipulator_driver = Node(
      package='mf_robot_driver',
      executable='dsr_driver_node.py',
