...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'depth_module.depth_profile',         'default': '640x480x5', 'description': 'depth module profile'},
                           {'name': 'enable_depth',                 'default': 'true', 'description': 'enable depth stream'},
                           {'name': 'depth_module.color_profile',           'default': '640x480x5', 'description': 'color image width'},
                        #    {'name': 'depth_module.infra_profile',           'default': '640x480x5', 'description': 'infra image width'},
                           {'name': 'rgb_camera.enable_auto_exposure', 'default': 'true', 'description': 'enable/disable auto exposure for color image'},
                           {'name': 'enable_color',                 'default': 'true', 'description': 'enable color stream'},
                           {'name': 'enable_infra1',                'default': 'false', 'description': 'enable infra1 stream'},
                           {'name': 'enable_infra2',                'default': 'false', 'description': 'enable infra2 stream'},
                           {'name': 'infra_rgb',                    'default': 'false', 'description': 'enable infra2 stream'},
                           {'name': 'enable_fisheye1',              'default': 'false', 'description': '(t265) enable fisheye1 stream'},
                           {'name': 'enable_fisheye2',              'default': 'false', 'description': '(t265) enable fisheye2 stream'},
...
rs-enumerate-devices
 ros2 launch realsense2_camera rs_launch.py serial_no:=412623070459 namespace:=cam1 &&
  ros2 launch realsense2_camera rs_launch.py serial_no:='218622272979' namespace:=cam2
 '''
