...
class ClickedPointDistance(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('csv_file', 'point_distances.csv')
        ...
        with open(self.csv_file, 'w', newline='') as csvfile:
            ...
            writer.writerow(['p1_x', 'p1_y', 'p1_z', 'p2_x', 'p2_y', 'p2_z', 'distance'])

        self.get_logger().info(f'Listening to clicked points on: {self.clicked_topic}')
        self.get_logger().info(f'Saving distances to: {self.csv_file}')
    ...
    def on_clicked(self, msg: PointStamped):
        # Transform point to target framea
        self.get_logger().info(f'Clicked point: {msg.point}')
        ...
        if len(self.last_points) == 2:
            ...
            with open(self.csv_file, 'a', newline='') as csvfile:
                writer = csv.writer(csvfile)
                writer.writerow([p1.x, p1.y, p1.z, p2.x, p2.y, p2.z, dist])
